    ...
    try:
        ...
        <head>
            <style>
                ...
                h1 {{ color: #2E86C1; font-size: 24pt; text-align: center; }}
                h2 {{ color: #1B4F72; font-size: 18pt; margin-top: 20px; border-bottom: 1px solid #ccc; }}
        ...
        <body>
            {html_text}
            <br><hr>
            <p style="text-align: center; color: #888;">Generated by ACE Engine</p>
        </body>
        </html>
        """
...
def get_image_bytes(prompt_text):
    ...
    try:
        # Simplify prompt and encode safely
